...
import { Anchor, Box, Button, Container, Flex, Group, Image, List, ListItem, Text, ThemeIcon, Title } from '@mantine/core';
  ...
  return (
    ...
    <Box size="lg" className={classes.borderBottom} hiddenFrom="sm" p={5}>
      <Flex className={classes.inner} wrap="wrap" justify="center">
        ...
        <Image src={image.src} className={classes.image} mt={20} w="75%" h="75%" />
      </Flex>
    </Box>
    </>
  );
