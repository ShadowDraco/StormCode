        ...
        <div className={classes.inner}>
          ...
          <div className={classes.content}>
            <Title className={classes.title}>
              Custom <span className={classes.highlight}>Local</span> Gaming
              PC's <br />
            </Title>
            ...
            >
              ...
              <ListItem>
                <b>Small Build Fee</b> – Even with a build fee expect to{" "}
                <strong>Save</strong> $300 or more!
              </ListItem>
              <ListItem>
                <b>Testing</b> – Testing, Benchmarks, and Quality Assurance
                before pick up
              </ListItem>
            </List>
