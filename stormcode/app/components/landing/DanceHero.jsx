...
import { Anchor, Button, Container, Group, Flex, Image, List, ListItem, Text, ThemeIcon, Title, Box } from '@mantine/core';
  ...
  return (
    ...
    <Box size="lg" className={classes.borderBottom} hiddenFrom='sm' m={5}>
      <Flex wrap="wrap" justify="center" className={classes.inner}>
        ...
        <Image src={image.src} className={classes.image} w="75%" h="75%" mt={20}/>
      </Flex>
    </Box>
    </>
  );
